        ...
        <div class="max-w-md mt-8">
          <div class="grid grid-cols-1 gap-6">
            ...
            <label class="block">
              ...
              <textarea class="block w-full mt-1" rows="3" />
            </label>
            <div class="block">
              <div class="mt-2">
                <div>
      ...
      <div class="py-12">
        ...
        <div class="max-w-md mt-8">
          <div class="grid grid-cols-1 gap-6">
            ...
            <label class="block">
              <span class="text-gray-700">Email address</span>
              <input type="email" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="john@example.com">
            </label>
            <label class="block">
              <span class="text-gray-700">When is your event?</span>
      ...
      <div class="py-12">
        ...
        <div class="max-w-md mt-8">
          <div class="grid grid-cols-1 gap-6">
            ...
            <label class="block">
              <span class="text-gray-700">Additional details</span>
              <textarea class=" mt-0 block w-full px-0.5 border-0 border-b-2 border-gray-200 focus:ring-0 focus:border-black " rows="2" />
            </label>
            <div class="block">
              <div class="mt-2">
                <div>
      ...
      <div class="py-12">
        ...
        <div class="max-w-md mt-8">
          <div class="grid grid-cols-1 gap-6">
            ...
            <label class="block">
              <span class="text-gray-700">Additional details</span>
              <textarea class="block w-full mt-1 bg-gray-100 border-transparent rounded-md focus:border-gray-500 focus:bg-white focus:ring-0" rows="3" />
            </label>
            <div class="block">
              <div class="mt-2">
                <div>
                  <label class="inline-flex items-center">
                    <input type="checkbox" class="text-gray-700 bg-gray-200 border-transparent rounded focus:border-transparent focus:bg-gray-200 focus:ring-1 focus:ring-offset-2 focus:ring-gray-500">
                    <span class="ml-2">Email me news and special offers</span>
                  </label>
                </div>
              </div>
